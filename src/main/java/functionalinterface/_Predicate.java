...
public class _Predicate {
    public static void main(String[] args) {
        ...
        System.out.println("\n2 Functions");
        System.out.println("Is phone number valid and contains number 3 = "+isPhoneNumberValidPredicate.and(containsNumber3).test("00709877300"));
        System.out.println("Is phone number valid and contains number 3 = "+isPhoneNumberValidPredicate.and(containsNumber3).test("0700000000"));
